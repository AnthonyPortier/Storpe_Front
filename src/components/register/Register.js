        ...
        <div className="register-page-main-div">
            ...
            <Form className="register-page-form" onSubmit={(e) => handleClick(e)}>
                ...
                <FormGroup>
                    ...
                    <Input className="input-firstname" placeholder='Tape ton prénom'
                        type="text"
                        name="firstname"
                ...
                <FormGroup>
                    ...
                    <Input className="input-lastname" placeholder='Tape ton nom'
                        type="text"
                        name="lastname"
                ...
                <FormGroup>
                    ...
                    <Input type="password" minLenght={6} name="password" id="register-input-password" value={password} placeholder="Rentre ton mot de passe..." onChange={(evt) => handlePasswordChange(evt)} minLength='6' required />
                </FormGroup>
                {/* Mot de passe confirmé*/}
                <FormGroup>
                    <Label className="register-page-label" for="examplePasswordConfirmed">Confirmer</Label>
                    <p>{errorPassword}</p>
                    <Input type="password" name="password" value={confirmePassword} id="register-input-passwordConfirmed" placeholder="Confirme ton mot de passe..." onChange={(e) => handleConfirmePasswordChange(e)} required />
                </FormGroup>
